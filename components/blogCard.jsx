...
const BlogCard = ({ card }) => {
  let [featuredmedia, setembed] = React.useState({
    medium: {
      ...
      source_url:
        "http://ideas-digitales.tk/portafoliocms/wp-content/uploads/2021/03/imagen-posts.jpg",
    },
    large: {
      ...
      mime_type: "image/jpeg",
      source_url:
        "http://ideas-digitales.tk/portafoliocms/wp-content/uploads/2021/03/480417c4-47d0-36fa-81fe-2f8768810196-1024x682.jpg",
    },
    thumbnail: {
      ...
      mime_type: "image/jpeg",
      source_url:
        "http://ideas-digitales.tk/portafoliocms/wp-content/uploads/2021/03/480417c4-47d0-36fa-81fe-2f8768810196-150x150.jpg",
    },
    medium_large: {
      ...
      mime_type: "image/jpeg",
      source_url:
        "http://ideas-digitales.tk/portafoliocms/wp-content/uploads/2021/03/480417c4-47d0-36fa-81fe-2f8768810196-768x512.jpg",
    },
    full: {
      ...
      mime_type: "image/jpeg",
      source_url:
        "http://ideas-digitales.tk/portafoliocms/wp-content/uploads/2021/03/480417c4-47d0-36fa-81fe-2f8768810196.jpg",
    },
  });
  React.useEffect(() => {
  ...
  let image = card.acf.imagenes_bloq_landing
    ? card.acf.imagenes_bloq_landing
    : featuredmedia.medium.source_url;
  return (
      ...
      <div className="card ">
        ...
        <div className="card-body">
          ...
          <div className="card-text">
            <div dangerouslySetInnerHTML={{ __html: excerptText }}></div>
            <Link href={`/blog/${slug}`}>
