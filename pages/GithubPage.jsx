               ...
               <div className="my-3 col-md-6 col-lg-4">
                   <div className="card bg-light" data-aos="fade-in">
                        ...
                        <div className="p-3 card-body">
                            ...
                            <h2 className="p-0 text-center card-title">
                                {user.login}
                            </h2>
                            ...
                            <div className="">
                                <a href={user.html_url} className="btn btn-outline-secondary d-block" target="_blank"> <div className="fab fa-github"></div> Visitar Github</a>
