...
const BlogSingle = ({singlePost,error}) => {
    ...
    if(singlePost[0]===undefined) return <Custom404/>
        ...
        const title=singlePost[0].title.rendered ? singlePost[0].title.rendered : 'Error'
    ...
    const image =singlePost[0]._embedded['wp:featuredmedia'][0].media_details.sizes.full.source_url;
...
export async function getServerSideProps(context){
    ...
    const data = await fetch(`http://ideas-digitales.tk/portafoliocms/wp-json/wp/v2/posts/?_embed=true&slug="${post}"`);
